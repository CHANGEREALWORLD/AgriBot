...
//   const user = userData || {
//     name: "Laxmi",
//     email: "lyaxmi682004@gmail.com",
//     profileImage: "https://lh3.googleusercontent.com/a/ACg8ocJh3...",
//     farmDetails: {
//       farmSize: "48 acres",
//       soilType: "Sandy",
//       primaryCrop: "Millet",
...
//   // Mock activities (replace with actual API data)
...
//               <h4 className="card-title">Recent Activities (Last 5)</h4>
//               <div className="activities-list">
//                 {allActivities.slice(0, 5).map((activity) => (
//                   <div key={activity.id} className={`activity-card-item ${getActivityColor(activity.type)}`}>
...
//                         <span className="activity-result">Result: {activity.result}</span>
//                         <span className="activity-confidence">Confidence: {activity.confidence}%</span>
//                       </div>
//                     </div>
//                   </div>
//                 ))}
...
//                 </div>
//                 <div className="detail-row-full">
//                   <span className="detail-label-full">Irrigation System</span>
//                   <span className="detail-value-full">{user.farmDetails.irrigation}</span>
//                 </div>
//                 <div className="detail-row-full">
//                   <span className="detail-label-full">Farming Experience</span>
//                   <span className="detail-value-full">{user.farmDetails.experience}</span>
//                 </div>
//               </div>
//               <button className="btn-edit-farm">Edit Farm Details</button>
//             </div>
//           </div>
//         )}
...
//                 <h4 className="card-title">All Activities ({filteredActivities.length})</h4>
...
//   // Use actual API data or fallback to mock data
//   const user = userData || {
//     name: "Laxmi",
//     email: "lyaxmi682004@gmail.com",
//     profileImage: "https://lh3.googleusercontent.com/a/ACg8ocJh3...",
...
//     alert("Edit farm details functionality coming soon!");
//   }
...
//                 </div>
//               </div>
//               <button className="btn-edit-farm" onClick={handleEditFarm}>
//                 Edit Farm Details
//               </button>
//             </div>
//           </div>
...
//       const response = await post("/user/update-profile", profileData);
...
//   const showError = error && !userData;
